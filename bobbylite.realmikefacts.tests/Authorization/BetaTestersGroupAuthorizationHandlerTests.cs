...
public class BetaTestersGroupAuthorizationHandlerTests
{
    [Fact]
    public async Task HandleRequirementAsync_UserNotAuthenticated_CookieDeleted()
    {
        ...
        var handler = new BetaTestersGroupAuthorizationHandler(graphService, authorizationCookieService);
    ...
    private Mock<AuthorizationHandlerContext> CreateAuthorizationHandlerContext(bool isAuthenticated)
    {
        ...
        var context = new Mock<AuthorizationHandlerContext>(
            new[] { new BetaTestersGroupRequirement() }, user, null!);

        context.Object.Succeed(new BetaTestersGroupRequirement());
